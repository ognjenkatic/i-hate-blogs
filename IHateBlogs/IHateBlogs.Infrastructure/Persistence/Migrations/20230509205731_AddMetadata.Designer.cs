...
namespace IHateBlogs.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230509205731_AddMetadata")]
            ...
            modelBuilder.Entity("IHateBlogs.Domain.Entities.Post", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("WritingStartedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("writing_started_at");

                    b.Property<DateTimeOffset>("WritingStoppedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("writing_stopped_at");
